...
#ifndef FW_PLANNING_PLANNING__SPACES__TROCHOID_AIRPLANE_HPP_
#define FW_PLANNING_PLANNING__SPACES__TROCHOID_AIRPLANE_HPP_
 ...
 *inaccuracies.
 */
class TrochoidAirplaneStateSpace : public ob::CompoundStateSpace {
 private:
 ...
 public:
   ...
   */
  TrochoidAirplaneStateSpace(double turningRadius = 66.66667, double gam = 0.15, bool useEuclDist = false);

  /** \brief Destructor */
  virtual ~TrochoidAirplaneStateSpace();
   ...
   * Get the maximum extent of the RealVectorStateSpace part of the TrochoidAirplaneStateSpace */
...
#endif /* FW_PLANNING_PLANNING__SPACES__TROCHOID_AIRPLANE_HPP_ */
