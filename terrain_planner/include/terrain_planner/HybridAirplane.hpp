...
#ifndef FW_PLANNING_PLANNING__SPACES__HYBRID_AIRPLANE_HPP_
#define FW_PLANNING_PLANNING__SPACES__HYBRID_AIRPLANE_HPP_
 ...
 *inaccuracies.
 */
class HybridAirplaneStateSpace : public ob::CompoundStateSpace {
 private:
 ...
 public:
  ...
  class StateType : public ob::CompoundStateSpace::StateType {
   public:
    ...
    /**
     * @brief Get state of the hybrid state
     *
     * @return double
     */
    double getHybrid() const;
   ...
   */
  HybridAirplaneStateSpace(double turningRadius = 66.66667, double gam = 0.15, bool useEuclDist = false);

  /** \brief Destructor */
  virtual ~HybridAirplaneStateSpace();
   ...
   * Get the maximum extent of the RealVectorStateSpace part of the HybridAirplaneStateSpace */
   ...
   */
  virtual void interpolate(const DubinsPath& path, const ob::State* to, const SegmentStarts& segmentStarts, double t,
   ...
   */
  double getMinTurningRadius() const { return 1.0 / curvature_; };
 ...
 protected:
   ...
   */
  void calculateSegmentStarts(const ob::State* from, const ob::State* to, const DubinsPath& path,
                              SegmentStarts& segmentStarts) const;
   ...
   */
  void getStateOnCircle(const ob::State* from, const ob::State* to, int rl /* right (0), left (1)*/,
